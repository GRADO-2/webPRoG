                    ...
                    <div class="main-grid">
                        <div class="image-container">
                            <svg id="miSVG" width="300" height="300" viewBox="-210 -210 420 420">
                                ...
                                <text x="32" y="-5" font-size="12" fill="#94a3b8" text-anchor="middle">1</text>
                                <text x="62" y="-5" font-size="12" fill="#94a3b8" text-anchor="middle">2</text>
                                <text x="92" y="-5" font-size="12" fill="#94a3b8" text-anchor="middle">3</text>
                                <text x="122" y="-5" font-size="12" fill="#94a3b8" text-anchor="middle">4</text>
                                <text x="152" y="-5" font-size="12" fill="#94a3b8" text-anchor="middle">5</text>
                                <text x="182" y="-5" font-size="12" fill="#94a3b8" text-anchor="middle">6</text>
                                <text x="-28" y="-5" font-size="12" fill="#94a3b8" text-anchor="middle">-1</text>
                                <text x="-58" y="-5" font-size="12" fill="#94a3b8" text-anchor="middle">-2</text>
                                <text x="-88" y="-5" font-size="12" fill="#94a3b8" text-anchor="middle">-3</text>
                                <text x="-118" y="-5" font-size="12" fill="#94a3b8" text-anchor="middle">-4</text>
                                <text x="-148" y="-5" font-size="12" fill="#94a3b8" text-anchor="middle">-5</text>
                                <text x="-178" y="-5" font-size="12" fill="#94a3b8" text-anchor="middle">-6</text>
                                <text x="8" y="-27" font-size="12" fill="#94a3b8" text-anchor="middle">1</text>
                                <text x="8" y="-57" font-size="12" fill="#94a3b8" text-anchor="middle">2</text>
                                <text x="8" y="-87" font-size="12" fill="#94a3b8" text-anchor="middle">3</text>
                                <text x="8" y="-117" font-size="12" fill="#94a3b8" text-anchor="middle">4</text>
                                <text x="8" y="-147" font-size="12" fill="#94a3b8" text-anchor="middle">5</text>
                                <text x="8" y="-177" font-size="12" fill="#94a3b8" text-anchor="middle">6</text>
                                <text x="8" y="33" font-size="12" fill="#94a3b8" text-anchor="middle">-1</text>
                                <text x="8" y="63" font-size="12" fill="#94a3b8" text-anchor="middle">-2</text>
                                <text x="8" y="93" font-size="12" fill="#94a3b8" text-anchor="middle">-3</text>
                                <text x="8" y="123" font-size="12" fill="#94a3b8" text-anchor="middle">-4</text>
                                <text x="8" y="153" font-size="12" fill="#94a3b8" text-anchor="middle">-5</text>
                                <text x="8" y="183" font-size="12" fill="#94a3b8" text-anchor="middle">-6</text>
                                ...
                                <!-- Grid lines for R and R/2 (dynamically updated by JavaScript) -->
                                <g id="rGridLines"></g>

                                <!-- Area shapes (initially hidden until R is selected) -->
                                <g id="areaGroup"></g>
                                <g id="pointsGroup"></g>
                            </svg>
                        </div>
                            ...
                            <table name="histTable" class="history-table">
                                ...
                                <tbody>
                                    <% ResultsBean resultsBean=(ResultsBean) session.getAttribute("resultsBean");
                                        ...
                                        // Crear una copia e invertir para mostrar los más recientes primero
